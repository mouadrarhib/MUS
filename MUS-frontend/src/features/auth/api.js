...
const authAPI = {
  ...
  updateEmail: async (newEmail) => {
    const response = await client.patch(AUTH_ENDPOINTS.UPDATE_EMAIL, {
      new_email: newEmail,
    });
    return response.data;
  },
  ...
  updatePassword: async (oldPassword, newPassword) => {
    const response = await client.patch(AUTH_ENDPOINTS.UPDATE_PASSWORD, {
  ...
  resetPassword: async (newPassword) => {
    const response = await client.post(AUTH_ENDPOINTS.RESET_PASSWORD, {
      new_password: newPassword,
    });
    return response.data;
  },
  ...
  checkEmailExists: async (email) => {
    const response = await client.post(AUTH_ENDPOINTS.CHECK_EMAIL, {
      email,
    });
    return response.data;
  },
  ...
  forgotPassword: async (email, newPassword) => {
    const response = await client.post(AUTH_ENDPOINTS.FORGOT_PASSWORD, {
      email,
      new_password: newPassword,
    });
    return response.data;
  ...
  updateProfile: async (fullName) => {
    const response = await client.patch(AUTH_ENDPOINTS.UPDATE_PROFILE, {
      full_name: fullName,
    });
    return response.data;
  },
  ...
  toggleActive: async (isActive) => {
    const response = await client.patch(AUTH_ENDPOINTS.TOGGLE_ACTIVE, {
      is_active: isActive,
    });
    return response.data;
  },
  ...
  deleteUser: async () => {
    const response = await client.delete(AUTH_ENDPOINTS.DELETE_USER);
    return response.data;
  },

  getUserById: async (userId) => {
    const response = await client.get(`${AUTH_ENDPOINTS.GET_USER_BY_ID}/${userId}`);
    return response.data;
  },
