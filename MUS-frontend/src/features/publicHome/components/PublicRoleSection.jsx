...
// Accent color palette cycled per card for visual variety
const ACCENT_COLORS = [
      ...
      <Stack spacing={2} alignItems="center" textAlign="center" data-role-intro>
        ...
        <Typography
          ...
          sx={{
            ...
            color: (theme) =>
              theme.palette.mode === "dark" ? "#f4f1ff" : "#0d0b1a",
            maxWidth: 820,
          }}
        >
          A single academic workspace for students, teachers, and university
          communities
        </Typography>
        ...
        <Typography
          sx={{
            ...
            color: (theme) =>
              theme.palette.mode === "dark"
                ? "rgba(228,220,255,0.78)"
                : "#4d586b",
            lineHeight: 1.65,
          }}
        >
          MUS helps learners find reliable resources, prepare effectively for
          exams, coordinate university clubs and events, access structured
          academic notes, and maintain clear communication with teachers.
        </Typography>
      </Stack>

      {/* Cards Grid — all cards on one row on md+ */}
      <Box
        sx={{
          mt: { xs: 5, md: 6.5 },
          display: "grid",
          // Mobile: single column, Tablet: 2 columns, Desktop: one row for all cards
          gridTemplateColumns: {
            xs: "1fr",
            ...
            >
              ...
              <Typography
                sx={{
                  ...
                  fontWeight: 700,
                  color: (theme) =>
                    theme.palette.mode === "dark" ? "#f0ecff" : "#0f0d1c",
                  mb: 1,
                  lineHeight: 1.3,
                }}
              >
