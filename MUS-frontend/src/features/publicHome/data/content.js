...
export const aiCards = [
  {
    ...
    description: "Generate revision quizzes from curated material and train confidently before exam day.",
  },
  {
    icon: Psychology,
    title: "Get AI Learning Summaries",
    description: "Transform long resources into concise, structured summaries to accelerate understanding.",
  },
  {
    icon: Groups,
    title: "Study with Your Peers",
    description: "Share references and collaborate with students from your academic track.",
  },
];
